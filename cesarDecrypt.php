...
<html>
    ...
    <body class="bg-dark">
        <div class="container relative mx-auto">
            <header>
                <h2 class="text-3xl text-center text-green mt-28 ">Decryption By César</h2>
            </header>
            <form class="text-center text-white mt-28 form-anticlear" method="post" action="">
                ...
                <button type="submit" name="submit" class="px-5 py-3 mb-3 mt-9">DECRYPT</button>
            </form>

            <?php
            if(isset($result)){ 
                echo '<div class="w-3/4 mx-auto text-white">
                <p class="text-xl text-center">Your Decrypted message is :</p>
